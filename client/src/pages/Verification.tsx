...
export default function VerificationPage() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      setError("Falha ao iniciar o login do Discord. Por favor, tente novamente.");
        ...
        <div className="glass p-8 md:p-12 space-y-8">
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="text-gray-400 text-lg">
              Verifique sua conta para ganhar acesso
            </p>
          </div>
          ...
          <div className="text-center text-sm text-gray-500 space-y-2">
            <p>
              Ao clicar em "Entrar com Discord", você concorda com nossos Termos de Serviço
            </p>
            <p>
              Seus dados do Discord serão armazenados com segurança e usados apenas para verificação
            </p>
          </div>
        </div>
